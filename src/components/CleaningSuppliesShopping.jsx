...
import "./CleaningSuppliesShopping.css";
...
function CleaningSuppliesShopping() {
        ...
        <div className="rightSection">
          ...
          <div className="detailsBox">
            ...
            <ul>
              ...
              <li>
                Premium Quality Cleaning Product
              </li>
...
export default CleaningSuppliesShopping;